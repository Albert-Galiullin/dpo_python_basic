...
parentAge = int(input('Сколько ему лет? '))
parent = Parent(parentName, parentAge, children=[], children_count=0)

child_1Name = input('Как зовут ребенка? ')
child_1Age = int(input('Сколько лет? '))
if child_1Age + 16 > parentAge:
    print('Неверно введен возраст ребенка')
    child_1Age = int(input('Сколько лет? '))
...
if child_2Age + 16 > parentAge:
    print('Неверно введен возраст ребенка')
    child_2Age = int(input('Сколько лет? '))
